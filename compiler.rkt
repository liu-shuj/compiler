...
; inj-proj typecheck shrink uniquify reveal-functions convert-to-clos limit-functions remove-complex-opera* expose-allocation explicate-control select-instructions uncover-live allocate-registers patch-instructions print-x86 
